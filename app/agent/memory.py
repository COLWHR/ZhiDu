...
class PrivateMemory:
    ...
    def get_speech_history_str(self):
        ...
        history = "【我之前的发言】\n"
        for i, speech in enumerate(self.speeches[-3:], 1):
    ...
    def get_recent_thought_str(self):
        ...
        focus = last_thought.get("focus", "N/A")
        action = last_thought.get("action", "N/A")
        style = last_thought.get("style", last_thought.get("attitude", "N/A"))
        return f"上次思考: {focus} | 焦点: {action} | 风格: {style}"
